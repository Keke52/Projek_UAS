	<div class="row">
			<div class="col-md-12">
				<center>Copyright &copy <?php echo date ('Y');?> Website Institut Teknologi dan Bisnis Indonesia, design with <span class="glyphicon glyphicon-heart"></span> by Ineke Eliza Hafifah <br/>
